...
public class Constants {
    ...
    public static class ObjectConstants{
        ...
        public static final int SPIKE_TRAP = 4;
        ...
        public static final int SPIKE_TRAP_WIDTH_DEFAULT = 32;
        public static final int SPIKE_TRAP_HEIGHT_DEFAULT = 32;
        public static final int SPIKE_TRAP_WIDTH = (int) (Game.SCALE * SPIKE_TRAP_WIDTH_DEFAULT);
        public static final int SPIKE_TRAP_HEIGHT = (int) (Game.SCALE * SPIKE_TRAP_HEIGHT_DEFAULT);
